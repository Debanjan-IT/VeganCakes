...
public class PrepareOrder extends javax.swing.JFrame {
    ...
    public void updateOrders(String order[]) {
        order_id.setText(order[0]);
        name.setText(order[1]);
        cake.setText(order[2]);
        cookie.setText(order[3]);
        drink.setText(order[4]);
        extra.setText(order[5]);
    }
    /**
    ...
    private void initComponents() {
        ...
        cake = new javax.swing.JTextField();
        ...
        jButton1.setText("READY TO SERVE");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(cookie)
                        .addComponent(drink)
                        .addComponent(extra, javax.swing.GroupLayout.DEFAULT_SIZE, 347, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String query = "DELETE FROM orders_to_be_prepared WHERE id = '"+id+"'";
            conn.createStatement().executeUpdate(query);
            JOptionPane.showMessageDialog(this,"Order Prepared...");
    ...
    private javax.swing.JTextField cake;
